...
| 스팬 | 합성도 f | CLT 과대비 | αL |
|---|---|---|---|
| 1 mm | 1.04% | **18.29배** | 0.36 |
| 5 mm | 19.96% | 4.25배 | 1.77 |
| 10 mm | 46.77% | **2.03배** | 3.55 |
| 50 mm | 88.72% | 1.12배 | 17.7 |
| 200 mm | 97.18% | 1.03배 | 70.9 |

**스팬이 필수 입력인 이유가 이 표다** — 같은 스택이 스팬에 따라 18배에서 1.03배까지 갈린다.
...
④ 실측 랜드마크(f 46.8%, 2.03배) ⑤ 짧은 스팬 αL<1 경고 ⑥ 강한 중간층 미탐지
